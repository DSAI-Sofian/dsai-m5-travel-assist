...
- [📌 Overview](#-overview)
  ...
  - [🤖 Link to SEA Travel Planner Bot](#-link-to-sea-travel-planner-bot)
- [🚀 Key Capabilities](#-key-capabilities)
  - [✅ Core Features](#-core-features)
  - [🏙️ Multi-City Planning Status](#️-multi-city-planning-status)
- [🧠 Architecture Overview](#-architecture-overview)
  - [Sprint 6.x Intelligence Evolution](#sprint-6x-intelligence-evolution)
  - [Current Orchestration Pipeline](#current-orchestration-pipeline)
- [⚙️ Multi-Agent Responsibilities](#️-multi-agent-responsibilities)
- [📊 Deterministic Ranking System](#-deterministic-ranking-system)
  - [Current Scoring Weights](#current-scoring-weights)
...
- [📦 Example Request Contract](#-example-request-contract)
- [📤 Example Response Structure](#-example-response-structure)
- [✈️ Travel Output Features](#️-travel-output-features)
- [🔒 Governance \& Security](#-governance--security)
  - [Security Decisions Implemented](#security-decisions-implemented)
  - [Intentionally Avoided](#intentionally-avoided)
- [🧪 Testing \& Quality Assurance](#-testing--quality-assurance)
  - [QA Coverage Includes](#qa-coverage-includes)
- [💬 Telegram Usage Guide](#-telegram-usage-guide)
  - [Recommended Prompt Format](#recommended-prompt-format)
- [🔁 Follow-Up Interaction Examples](#-follow-up-interaction-examples)
- [⚠️ Current Limitations](#️-current-limitations)
  - [Known Constraints](#known-constraints)
- [🧭 Sprint Progression Summary](#-sprint-progression-summary)
- [🔮 Future Roadmap](#-future-roadmap)
  ...
  - [Sprint 9.x — Real API Integration](#sprint-9x--real-api-integration)
  - [Sprint 10.x — Persistent Personalization Memory](#sprint-10x--persistent-personalization-memory)
  - [Sprint 11.x — Booking Readiness](#sprint-11x--booking-readiness)
  - [Sprint 12.x — Agent Scaling](#sprint-12x--agent-scaling)
  - [Sprint 13.x — Conversational Expansion](#sprint-13x--conversational-expansion)
- [🎨 Optional UX Improvements](#-optional-ux-improvements)
  - [Softer Realism Messaging](#softer-realism-messaging)
  - [Enhanced Reviewer Tone](#enhanced-reviewer-tone)
  - [Telegram Compact Rendering](#telegram-compact-rendering)
- [🏗️ Current Architecture Maturity](#️-current-architecture-maturity)
- [📈 Engineering Principles](#-engineering-principles)
- [🧠 What This Project Demonstrates](#-what-this-project-demonstrates)
- [⚠️ Disclaimer](#️-disclaimer)
- [👤 Author - Sofian Bin Sidik (S7525372/I)](#-author---sofian-bin-sidik-s7525372i)
  - [💬 Feedback \& Suggested Improvements](#-feedback--suggested-improvements)
